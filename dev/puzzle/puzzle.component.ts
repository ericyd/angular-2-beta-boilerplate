...
@Component({
    ...
    template: `
        ...
        >
            ...
            <p>Welcome to <span class="name">{{name.value}}</span></p>
            <br>
            Switch 1:
            <input type="text" #switch1  (keyup)="0" value='-1'>
            <br>
            Switch 2:
            <input type="text" #switch2 (keyup)="0" value='-1'>
            <br>
            Switch 3:
            <input type="text" #switch3 (keyup)="0" value='-1'>
            <br>
            Switch 4:
            <input type="text" #switch4 (keyup)="0" value='-1'>
        </section>
        
        <h2
        [hidden]="switch1.value != switch1Number || 
                    switch2.value != switch2Number ||
                    switch3.value != switch3Number ||
                    switch4.value != switch4Number">
